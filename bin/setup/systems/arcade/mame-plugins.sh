...
__build_mame2016() {
  if has_emulator 'lr-mame2016' && [ ! -f "$HOME/RetroPie/BIOS/mame2016/plugins/boot.lua" ]; then
...
__build_mame() {
  if has_emulator 'lr-mame' && [ ! -f "$HOME/RetroPie/BIOS/mame/plugins/boot.lua" ]; then

...
__configure_shared_overrides() {
  while read shared_config_name; do
    ini_merge "{config_dir}/retroarch/$shared_config_name.cfg" "$retropie_configs_dir/all/$shared_config_name.cfg" backup=false comments='^#include ' overwrite=true
